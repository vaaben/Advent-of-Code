...
import com.degofedal.advent.advent2019.Dec5a.iComp
...
object Dec5a extends AdventOfCode with App {
  ...
  //val iComp = new IntcodeComputer("2019/dec2a.txt")


  //iComp.setProgram("1,0,0,0,99")
  //iComp.run
  //println(iComp.program) // 2,0,0,0,99

  //iComp.setProgram("2,3,0,3,99")
  //iComp.run
  //println(iComp.program) // 2,3,0,6,99

  //iComp.setProgram("2,4,4,5,99,0")
  //iComp.run
  //println(iComp.program) // 2,4,4,5,99,9801

  //iComp.setProgram("1,1,1,4,99,5,6,0,99")
  //iComp.run
  //println(iComp.program) // 30,1,1,4,2,5,6,0,99

  //iComp.program(1) = 12
  //iComp.program(2) = 2

  val iComp = new IntcodeComputer("2019/dec5a.txt")
  iComp.input = () => 1
  iComp.silent = false
  iComp.run
  // input 1
...
object Dec5b extends AdventOfCode with App {
  ...
  //iComp.setProgram("3,9,8,9,10,9,4,9,99,-1,8")
  //iComp.setProgram("3,9,7,9,10,9,4,9,99,-1,8")
  //iComp.setProgram("3,3,1108,-1,8,3,4,3,99")
  //iComp.setProgram("3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9")
  iComp.input = () => 5
  iComp.silent = false
  iComp.run
  // input 5
