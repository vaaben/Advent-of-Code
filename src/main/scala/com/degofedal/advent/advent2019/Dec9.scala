...
object Dec9a extends AdventOfCode with App {
  ...
  val iComp = new IntcodeComputer("2019/dec9a.txt")

  iComp.input = () => 1

  //iComp.setProgram("109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99")
  //iComp.setProgram("1102,34915192,34915192,7,4,7,99,0")
  //iComp.setProgram("104,1125899906842624,99")
  iComp.silent = false
